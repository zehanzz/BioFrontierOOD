...
from biodataset import CustomerDatasetGraph
...
def main(args):
    ...
    dataset = CustomerDatasetGraph(noise_type=args.noise, value_type=args.value, sort_type=args.sort)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", choices=["ERM", "W2D", "MixUp", "DeepCoral", "BIOW2D"], required=True, help="Choose algorithm")
    ...
    parser.add_argument("--model", choices=["GATNet", "GINConvNet", "GAT_GCN", "GCNNet"], required=True, help="Choose model")
